  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-2 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl lg:text-6xl mb-4 text-black dark:text-white max-w-4xl font-bold">
          Event{" "}
          <PointerHighlight
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-base md:text-lg max-w-2xl">
          Complete journey from registration to the grand finale
        </p>
      </div>
