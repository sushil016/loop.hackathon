  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        ...
        {/* Subtitle */}
        <p className="text-base sm:text-lg md:text-xl text-white/50 font-light mb-10 sm:mb-12 max-w-xl mx-auto animate-fade-in-up delay-300 px-4">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-6 mb-10 sm:mb-14 animate-fade-in-up delay-400">
        ...
        {/* Stats Row */}
        <div className="mt-10 sm:mt-12 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-12 animate-fade-in-up delay-500">
          <div className="text-center">
            <p className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2">₹1L+</p>
            <p className="text-white/40 text-xs sm:text-sm font-medium tracking-wide uppercase">Prize Pool</p>
          </div>
          <div className="text-center">
            <p className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2">24</p>
            <p className="text-white/40 text-xs sm:text-sm font-medium tracking-wide uppercase">Hours</p>
          </div>
          <div className="text-center">
            <p className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2">3-6</p>
            <p className="text-white/40 text-xs sm:text-sm font-medium tracking-wide uppercase">Per Team</p>
          </div>
          <div className="text-center">
            <p className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2">100+</p>
            <p className="text-white/40 text-xs sm:text-sm font-medium tracking-wide uppercase">Teams</p>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-full px-4">
        <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4 sm:gap-8 mb-4 animate-fade-in-up delay-350">
          <a
          ...
          >
            ...
            <span className="text-xs sm:text-sm font-medium">loop.hackathon</span>
          </a>
          <a
          ...
          >
            ...
            <span className="text-xs sm:text-sm font-medium hidden sm:inline">loop-hackathon.vercel.app</span>
            <span className="text-xs sm:text-sm font-medium sm:hidden">Website</span>
          </a>
          <a
          ...
          >
            ...
            <span className="text-xs sm:text-sm font-medium hidden sm:inline">loop.hackathon@bvcoenm.edu.in</span>
