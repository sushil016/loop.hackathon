...
import { problemTracks } from "./data";
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
            ...
            <section key={track.id} className="scroll-mt-24">
              ...
              <div className="mb-8">
                <div className="flex items-start gap-4 mb-4">
                  <div className={`flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 rounded-xl bg-gradient-to-br ${track.color} flex items-center justify-center shadow-lg`}>
              ...
              <div className="grid gap-4 sm:gap-6">
                {track.problems.map((problem) => {
                  ...
                  return (
                    <div
                      key={problem.id}
                      className={`relative group rounded-xl border ${track.borderColor} bg-gradient-to-br from-white/[0.03] to-white/[0.01] backdrop-blur-sm transition-all duration-300 ${track.hoverGlow} hover:border-opacity-60`}
                    >
                      <div className="p-5 sm:p-6">
                        {/* Problem Header */}
                        <div className="flex items-start gap-3 sm:gap-4 mb-3">
                          <div className={`flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-br ${track.color} flex items-center justify-center text-white font-bold text-sm sm:text-base`}>
                            {problem.id}
                          </div>
                        ...
                        {problem.details && (
                          <button
                            ...
                            className={`mt-4 flex items-center gap-2 text-sm font-medium transition-colors ${isExpanded ? 'text-white' : 'text-white/60 hover:text-white'}`}
                          >
                            {isExpanded ? (
                              <>
        ...
        <section className="mt-16 sm:mt-24">
          <div className="bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 border border-blue-500/20 rounded-2xl p-6 sm:p-8">
